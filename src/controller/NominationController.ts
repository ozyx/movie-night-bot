import { getNominationCount, hasNominatedCategory } from "../service/nomination.service"
...
export class NominationController {
    public static async canNominate(user_id: string, category: string): Promise<boolean> {
